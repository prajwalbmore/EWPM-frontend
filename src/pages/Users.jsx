...
import { Plus, Trash2, Edit, User as UserIcon, Shield, Search, X } from 'lucide-react';
...
const Users = () => {
  ...
  const [filters, setFilters] = useState({ role: '', isActive: '', page: 1 });
  ...
  const filteredUsers = useMemo(() => {
    ...
    return users.filter((user) => {
      ...
      return (
        ...
        formatRole(user.role).toLowerCase().includes(q)
      );
    });
  }, [users, searchQuery]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        {canManageUsers && (
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-primary-500 px-4 py-2 text-sm font-semibold text-white hover:bg-primary-400"
          >
      ...
      {/* Search & Filters */}
      <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex gap-3 sm:gap-4">
          <select
            ...
            className="rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-sm text-white placeholder:text-white/40 outline-none focus:ring-2 focus:ring-primary-500/20"
          >
      ...
      {!isLoading && filteredUsers.length > 0 && (
        <div className="hidden md:block overflow-x-auto rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl custom-scrollbar-dark">
            ...
            <tbody>
              {filteredUsers.map((user) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm text-white/70 truncate">
                    {user.email}
                  </td>
                  <td className="px-6 py-4">
                    <span
                  ...
                  <td className="px-6 py-4 text-right flex gap-2 justify-end">
                    {(isSuperAdmin ||
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-xl bg-primary-500 px-3 py-2 text-xs font-semibold text-white hover:bg-primary-400"
                      >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-xl bg-rose-500/15 px-3 py-2 text-xs font-semibold text-rose-300 hover:bg-rose-500/20"
                    >
      ...
      {!isLoading && filteredUsers.length === 0 && (
        <div className="rounded-2xl border border-white/10 bg-white/5 p-12 text-center backdrop-blur-xl">
          <UserIcon className="mx-auto mb-4 h-12 w-12 text-white/40" />
          ...
          {canManageUsers && (
            <button
              onClick={handleCreate}
              className="mt-4 inline-flex items-center gap-2 rounded-xl bg-primary-500 px-4 py-2 text-sm font-semibold text-white hover:bg-primary-400"
            >
